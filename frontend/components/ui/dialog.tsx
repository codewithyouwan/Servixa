  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showClose && (
          <DialogClose className="absolute top-4 right-4 rounded-lg p-1 text-muted-foreground opacity-70 transition-opacity outline-none hover:opacity-100 focus-visible:ring-3 focus-visible:ring-ring/50">
