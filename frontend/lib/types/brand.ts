/** Brand Profile types — mirror backend/app/schemas/brand.py.
 * Company Overview -> the `company` table, Products/Services ->
 * `company_products`, Downloads -> the same `docs` table Feature 1/2 use.
 * Projects (case studies), Dealers & Distributors, and Support tickets are
 * new tables — see backend/db/schema.sql's "BRAND PROFILE" region.
 */
