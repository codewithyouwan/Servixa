...
import type { CrmDocumentCategory, CrmDocumentCreate } from "@/lib/provider/types";
...
/** Same approach as the Home Digital Twin's AddDocumentDialog — no real file
 * upload yet (no object storage wired up), so this captures the structured
 * metadata a real upload flow would extract/confirm. */
