...
import type { BrandDownload } from "@/lib/types";
import { DOWNLOAD_CATEGORIES, DOWNLOAD_CATEGORY_ORDER } from "@/lib/constants/brand-download-categories";
 ...
 * Marketing), so — like CRM's Documents section — it gets its own
 * horizontal tab bar. Same pattern as digital-twin-tabs.tsx: horizontal
 * tabs for sub-categories *within* a section, not for switching between
 * top-level sections (that's the sidebar tree). */
